...
- Standardise on **Google AI Studio** (Gemini 2.5 Flash) for all inference to retire the brittle
  Vertex AI path.
...
- **AI Studio only:** Disable or remove Vertex credentials, service accounts, and code paths. Use AI
  Studio SDK/REST with explicit project-level quotas and audit logging.
...
| ---------------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------- |
| **0. Platform prep**         | Tape off Vertex, wire AI Studio | • Remove Vertex client libs and credentials<br>• Stand up AI Studio project + service identity<br>• Add config toggles for AI Studio API keys per environment<br>• Update cost dashboards to expect AI Studio billing exports                                      | No code paths can hit Vertex; smoke test AI Studio token counting job               |
